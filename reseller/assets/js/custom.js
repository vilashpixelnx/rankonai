...
(function($) {
    ...
    var ShowcaseAI = {
        ...
        FAQAccordion: function() {
            ...
            // open a default item on load (if marked)
            var $default = $('.fe_faq_item.fe_faq_default_open').first();
            if ($default.length) {
                var $defBody = $default.addClass('fe_faq_open').find('.fe_faq_a');
                $defBody.css('max-height', $defBody.prop('scrollHeight') + 'px');
                $default.find('.fe_faq_q').attr('aria-expanded', 'true');
            }
